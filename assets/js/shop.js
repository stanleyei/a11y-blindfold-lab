...
(function () {
  'use strict';
  const PRODUCTS = [
    { id: 'bt-pro', name: '藍牙耳機 Pro', price: 2990, tags: ['耳機', '藍牙', '無線'], img: 'DSC_0417.webp', desc: '主動降噪，續航 30 小時。' },
    { id: 'wired-lite', name: '有線耳機 Lite', price: 590, tags: ['耳機', '有線'], img: 'DSC_0418.webp', desc: '3.5mm 接頭，附麥克風。' },
    { id: 'anc-over', name: '降噪耳罩式耳機', price: 4990, tags: ['耳機', '藍牙', '降噪'], img: 'DSC_0419.webp', desc: '耳罩式設計，長時間配戴舒適。' },
    { id: 'bottle', name: '不鏽鋼保溫瓶', price: 890, tags: ['生活', '保溫'], img: 'DSC_0420.webp', desc: '500ml，保溫 12 小時。' },
    { id: 'notebook', name: '方格筆記本', price: 180, tags: ['文具'], img: 'DSC_0421.webp', desc: 'A5，160 頁。' },
    { id: 'tote', name: '帆布袋', price: 450, tags: ['生活', '袋'], img: 'DSC_0422.webp', desc: '厚磅帆布，可機洗。' },
  ];
